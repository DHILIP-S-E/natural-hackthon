...
# AI Agent Handlers
from agents.track2_staff import ai_upsell_suggestions_handler, onboarding_progress_handler
from agents.track5_experience import rapport_handover_handler
from agents.track6_intelligence import unified_intelligence_handler
...
async def create_staff(
    ...
    from models.staff import SkillLevel
    staff = StaffProfile(
...
async def get_staff_upsell_suggestions(
    ...
    from agents.track2_staff import AIUpsellRequest
