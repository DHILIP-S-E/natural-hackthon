...
from models import ClimateRecommendation
...
async def get_climate(city: str, db: AsyncSession = Depends(get_db), user=Depends(get_current_user)):
    ...
    from services.weather_service import get_or_refresh_climate
...
async def refresh_climate(
    ...
    from services.weather_service import fetch_and_store_climate
