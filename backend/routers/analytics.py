...
from utils.dependencies import get_current_user, require_any_staff, require_roles
from schemas.common import APIResponse

# Track 6 AI Agent Handlers
from agents.track6_intelligence import (
...
async def franchise_bi_agent(
    ...
    return await franchise_bi_dashboard_handler(None, db, user)
...
async def franchise_compare_agent(
    ...
    return await franchise_live_compare_handler(db, user)
...
async def skill_gap_forecast_agent(
    ...
    return await ai_skill_gap_forecast_handler(None, db, user)
