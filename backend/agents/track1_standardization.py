...
from agents import AgentAction, register_agent
from models.user import User
from models.customer import CustomerProfile
from models.service import Service, SOP
from models.booking import Booking, BookingStatus
from models.session import ServiceSession, SessionStatus
from models.quality import QualityAssessment, SkillAssessment
from models.staff import StaffProfile, SkillLevel
...
from models.queue import SmartQueueEntry, QueueStatus
...
async def quality_score_compute_handler(
    ...
    composite = (
        ...
        + (customer_score if has_feedback else 50) * weights["customer_feedback"]
