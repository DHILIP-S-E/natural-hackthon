...
const navItems: Record<string, NavItem[]> = {
  customer: [
    ...
    { to: '/app/passport', icon: <BookOpenCheck size={20} />, label: 'Beauty Passport' },
    { to: '/app/twin', icon: <GitBranch size={20} />, label: 'Beauty Twin' },
    { to: '/app/mirror', icon: <Scan size={20} />, label: 'AI Mirror' },
    { to: '/app/bookings', icon: <Calendar size={20} />, label: 'Bookings' },
    { to: '/app/skin-tone', icon: <Sparkles size={20} />, label: 'Skin Tone AI' },
    { to: '/app/journey', icon: <Route size={20} />, label: 'Journey & Goals' },
    { to: '/app/soulskin', icon: <Heart size={20} />, label: 'SOULSKIN AI' },
    { to: '/app/homecare', icon: <Zap size={20} />, label: 'AI Homecare' },
    { to: '/app/loyalty', icon: <Trophy size={20} />, label: 'AURA Points' },
  ...
  stylist: [
    ...
    { to: '/stylist/aurascore', icon: <Award size={20} />, label: 'AuraScore' },
    ...
    { to: '/stylist/voice', icon: <Mic size={20} />, label: 'Voice Assistant' },
  ],
  salon_manager: [
    ...
    { to: '/manager/aurascore', icon: <Award size={20} />, label: 'AuraScore' },
    ...
    { to: '/manager/inventory', icon: <Package size={20} />, label: 'Inventory' },
    { to: '/manager/eco', icon: <Leaf size={20} />, label: 'Eco Tracker' },
    { to: '/manager/reports', icon: <BarChart3 size={20} />, label: 'Reports' },
    { to: '/manager/feedback', icon: <MessageSquare size={20} />, label: 'Feedback' },
    { to: '/manager/leaderboard', icon: <Trophy size={20} />, label: 'Leaderboard' },
    { to: '/manager/alerts', icon: <Bell size={20} />, label: 'Alerts' },
  ],
  franchise_owner: [
    { to: '/franchise/dashboard', icon: <LayoutDashboard size={20} />, label: 'Dashboard' },
    { to: '/franchise/performance', icon: <Activity size={20} />, label: 'Network Performance' },
  ...
  regional_manager: [
    ...
    { to: '/regional/performance', icon: <Activity size={20} />, label: 'Network Performance' },
  ...
  super_admin: [
    ...
    { to: '/admin/performance', icon: <Activity size={20} />, label: 'Network Performance' },
    ...
    { to: '/admin/aurascore', icon: <Award size={20} />, label: 'AuraScore' },
    ...
    { to: '/admin/eco', icon: <Leaf size={20} />, label: 'Eco Tracker' },
